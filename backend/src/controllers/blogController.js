...
//       const guessedTitle =
//         extractedText.split(".")[0]?.slice(0, 80) ||
...
//     res.status(201).json({
//       message: "PDF blogs uploaded successfully",
...
//       .select("title slug excerpt domainName createdAt sourcePdfName")
//       .sort({ createdAt: -1 });
...
//           failedFiles.push({
//             file: file.originalname,
//             reason: `PDF parse failed: ${parseError.message}`
//           });
//           continue;
//         }
...
//     });
//   } catch (error) {
//     console.error("uploadPdfBlogs controller error:", error);
